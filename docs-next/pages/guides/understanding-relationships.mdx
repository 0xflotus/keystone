...
Once you understand these core concepts you can follow the [configuration relationships](./configuring-relationships) guide to put these ideas into practice.

## Defining a relationship

Relationships are implemented using the [`relationship`](../apis/fields#relationship) field type and defined along with other fields in [`list()`](../apis/schema#fields).
...
If you need help deciding which options to use, please consult the [relationship configuration guide](./relationships).
